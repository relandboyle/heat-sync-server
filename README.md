TempData Collector integrates with network-connected temperature sensors to generate time-series data which can be displayed or reported in various ways.
